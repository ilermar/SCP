      ...
      <table class="header centered" style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto;width: 602px">
        ...
        <tr><td class="logo" style="padding: 32px 0;vertical-align: top;mso-line-height-rule: at-least"><div class="logo-left" style="font-size: 26px;font-weight: 700;letter-spacing: -0.02em;line-height: 32px;color: #41637e;font-family: sans-serif" align="left" id="emb-email-header"><a style="text-decoration: none;transition: all .2s;color: #41637e" href="http://www.drsergioramosreyes.com"><img style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 50px" src="http://scp.drsergioramosreyes.com/images/logo.40847f62.png" alt="Sistema de Control de Pacientes" width="50" height="50" /></a></div></td></tr>
          ...
          <table class="centered" style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto">
            ...
            <h1 style="Margin-top: 0;color: #565656;font-weight: 700;font-size: 36px;Margin-bottom: 18px;font-family: sans-serif;line-height: 42px">Datos de tu cuenta</h1>
            <p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">Se ha solicitado la recuperación de contraseña para tu usuario en el Sistema de Control de Pacientes del Dr sergio Ramos y Dr Paris Ramos.</p>
            <p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 24px">La contraseña para ingresar es:  <strong style="font-weight: bold"><?php echo $password;?></strong>
            </p>
            <p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 24px">
            Podrás ingresar desde esta dirección <strong style="font-weight: bold">http://scp.drsergioramosreyes.com</strong> o bien dando click en el siguiente enlace:
            </p>

            <a style="border: 1px solid #ffffff;display: inline-block;font-size: 13px;font-weight: bold;line-height: 15px;outline-style: solid;outline-width: 2px;padding: 10px 30px;text-align: center;text-decoration: none !important;transition: all .2s;color: #fff !important;font-family: Georgia,serif;background-color: #41637e;outline-color: #41637e;text-shadow: 0 1px 0 #3b5971" href="http://scp.drsergioramosreyes.com" target="_blank">Ingresar</a>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                  ...
                  <table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%">
                    <tbody><tr>
                      <td class="padded" style="padding: 0;vertical-align: top;padding-left: 0;padding-right: 10px;word-break: break-word;word-wrap: break-word;text-align: left;font-size: 12px;line-height: 20px;color: #999;font-family: Georgia,serif">
                        Contáctanos:<br>
                        Justo Sierra N° 190 a una cuadra de Carranza por Chilli's Tequis<br>
                        Tel: 817-14-51 y 811-99-93<br>
                          ...
                          <span class="block">
                            <span>
                              <preferences style="font-weight:bold;text-decoration:none;" lang="en">
                                Desarrollado por <a href="http://www.zagon.co" target="_blank">Zagon.co</a>
                              </preferences>
                            </span>
                          </span>
